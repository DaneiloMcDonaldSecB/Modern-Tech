...
const App = () => {
  ...
  //  Fetches multiple random images separately
  ...
  const handleSubmitMultipleFiles = async (e) => {
    ...
    try {
      ...
      console.log("Files uploaded:", data.filePaths); 
    } catch (error) {
  ...
  //  Uploads the dog image to Express
  const uploadDogImage = async () => {
    ...
    try {
      ...
      console.log("Dog image uploaded:", data.imageUrl); 
    } catch (error) {
